...
public class Kadai3Flink {
    ...
    static final String TOPIC_SCD41_TEMPERATURE =
            "i483-sensors-" + STUDENT + "-SCD41-temperature";
    static final String TOPIC_SCD41_HUMIDITY =
            "i483-sensors-" + STUDENT + "-SCD41-humidity";

    static final String TOPIC_BH1750_ILLUMINATION =
            "i483-sensors-" + STUDENT + "-BH1750-illumination";

    static final String TOPIC_RPR0521_ILLUMINATION =
            "i483-sensors-" + STUDENT + "-RPR0521-illumination";
    static final String TOPIC_RPR0521_INFRARED =
            "i483-sensors-" + STUDENT + "-RPR0521-infrared_illumination";

    static final String TOPIC_DPS310_AIR_PRESSURE =
            "i483-sensors-" + STUDENT + "-DPS310-air_pressure";
    static final String TOPIC_DPS310_TEMPERATURE =
            "i483-sensors-" + STUDENT + "-DPS310-temperature";
    ...
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<SensorRecord> source = KafkaSource.<SensorRecord>builder()
                ...
                .setTopics(Arrays.asList(
                        TOPIC_SCD41_CO2,
                        TOPIC_SCD41_TEMPERATURE,
                        TOPIC_SCD41_HUMIDITY,
                        TOPIC_BH1750_ILLUMINATION,
                        TOPIC_RPR0521_ILLUMINATION,
                        TOPIC_RPR0521_INFRARED,
                        TOPIC_DPS310_AIR_PRESSURE,
                        TOPIC_DPS310_TEMPERATURE
                ))
                // .setGroupId("kadai3-1a-" + STUDENT)
                .setGroupId("kadai3-1b-" + STUDENT)
        ...
        env.execute("Kadai3 1-b Flink Analytics");
    }
